...
print("\n" + "="*60)
print("--- 5. Entrenamiento del Modelo KNN ---")
print("="*60)
...
# Puedes experimentar con diferentes valores de 'n_neighbors' (el número de vecinos)
knn_model = KNeighborsClassifier(n_neighbors=5) # Usamos 5 vecinos como ejemplo inicial

# 2. Entrenar el modelo KNN con los datos de entrenamiento
knn_model.fit(X_train, y_train)

# 3. Realizar predicciones en el conjunto de prueba
y_pred_knn = knn_model.predict(X_test)

# 4. Evaluar el modelo KNN
...
plt.xlabel('Predicciones (KNN)')
plt.ylabel('Valores Reales')
plt.title('Matriz de Confusión (KNN)')
plt.show()

print("\n--- Fin del Entrenamiento del Modelo KNN ---")
print("="*60)
